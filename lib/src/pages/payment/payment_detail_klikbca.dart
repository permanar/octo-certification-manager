...
class PaymentDetailKlikBCA extends StatefulWidget {
  @override
  _PaymentDetailKlikBCAState createState() => _PaymentDetailKlikBCAState();
}

class _PaymentDetailKlikBCAState extends State<PaymentDetailKlikBCA> {
