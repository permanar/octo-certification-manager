...
class PaymentDetailGopay extends StatefulWidget {
  @override
  _PaymentDetailGopayState createState() => _PaymentDetailGopayState();
}

class _PaymentDetailGopayState extends State<PaymentDetailGopay> {
